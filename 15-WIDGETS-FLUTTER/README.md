...
- Arsenal completo de consulta rápida

---

## 🔗 Relaciones con otros módulos

| Tema | Módulo relacionado | Naturaleza |
|---|---|---|
| State management con BLoC/Cubit | [16-BLOC-CUBIT/](../16-BLOC-CUBIT/) | 15 enseña widgets puros, 16 añade BlocBuilder/BlocProvider |
| StreamBuilder y data binding | [16-BLOC-CUBIT/01-conceptos-bloc-cubit.md](../16-BLOC-CUBIT/01-conceptos-bloc-cubit.md) | Complementario: streams en UI vs streams en BLoC |
| Diseño visual de pantallas | [08-PENCIL/](../08-PENCIL/) | Pencil para diseñar, widgets para implementar |
| Testing de widgets | [05-TESTING/04-presentation/04b-practica-widgets.md](../05-TESTING/04-presentation/04b-practica-widgets.md) | Cómo testear los widgets de este módulo |

---

## 🚀 Siguiente paso

Continúa con [16-BLOC-CUBIT/](../16-BLOC-CUBIT/) para aprender a manejar el estado de tu aplicación con BLoC y Cubit.
