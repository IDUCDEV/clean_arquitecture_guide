...
## Pestañas del CPU Profiler

| Pestaña | Propósito |
|---------|-----------|
| **Profile** | Resumen de uso de CPU |
...
## Grabar perfil de CPU

### Pasos
1. Ir a CPU Profiler en DevTools
2. Click en "Record" (🔴) o presionar `Ctrl+Shift+R`
3. Interactuar con la app (reproducir el problema)
4. Click en "Stop" para detener grabación
...
| Opción | Descripción |
|--------|-------------|
| **Profile on device** | Grabar en el dispositivo (recomendado) |
| **Profile on VM** | Grabar en el VM (debugging) |
| **Sampling rate** | Frecuencia de muestreo (default: 1000Hz) |
| **Include dart:ui** | Incluir llamadas a framework Flutter |

---

## Interpretando resultados

### Profile View (resumen)
...
### Bottom Up (funciones costosas primero)
...
## Causas comunes de alto uso de CPU

### 1. Build methods costosos
...
### 2. Imágenes sin cache

**Problema:**
```dart
// ❌ Descarga imagen en cada build
Image.network(
...
**Fix:**
```dart
// ✅ Usa cache implícito de Flutter
CachedNetworkImage(
...
// ✅ O mejor aún: usar RichText con constraints
ConstrainedBox(
...
### Ejercicio 1: Identificar widget costoso
...
### Ejercicio 2: Medir impacto de const
...
Column(
  children: [
    const Text('Hello'),  // Se reutiliza instancia
...
### Ejercicio 3: Flame Chart de animación
...
---
→ Siguiente: `05-memory-profiler.md`
