# 05: Workflow de Debugging por Tipo de Bug

> Diferentes tipos de bugs requieren diferentes estrategias. Este archivo te da el workflow exacto para cada tipo.

---

## Framework general de debugging
...
## Tipo 1: UI Bug (algo se ve mal)

**Flujo:**
```
1. Widget Inspector (DevTools)
2. Select Widget Mode (VSCode: Shift+Cmd+P → Flutter: Select Widget)
...
## Tipo 2: State Bug (estado inconsistente)
...
4. Usar DevTools → State Management (si usa BLoC)
...
## Tipo 3: Performance Bug (app lenta)
...
## Tipo 6: Build Error (compilación)
...
## Cheat Sheet: ¿Qué herramienta para qué?

| Bug | Herramienta | Atajo |
|-----|-------------|-------|
| UI se ve mal | Widget Inspector | Shift+Cmd+P |
...
| Hot Reload no funciona | Hot Restart | Shift+F5 |
