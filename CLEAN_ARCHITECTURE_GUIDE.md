...
--------------------|----------------------|--------------------
                    |                      |
[Widget] --calls-> [Cubit] --calls-> [UseCase] --calls-> [Repository] --calls-> [DataSource]
   /|\                |                      | (Interface)         (Implementation) |
    |                 |                      |                      |                |
    |                 |                      |                      |            (API/DB)
[State] <-updates-- [Cubit] <--returns-- [UseCase] <--returns-- [Repository] <--returns-- [Model]
 (UI rebuilt)       (emits state)      (Entity/Failure)       (Entity/Failure)      (Data)
