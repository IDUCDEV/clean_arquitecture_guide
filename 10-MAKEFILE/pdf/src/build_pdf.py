#!/usr/bin/env python3
"""
Build PDF guides for Module 10 - Makefile Mastery.
Generates two PDFs:
...
# ── Output files ──────────────────────────────────────────────────────────────
FULL_PDF = os.path.join(OUTPUT_DIR, "10-MAKEFILE.pdf")
SUMMARY_PDF = os.path.join(OUTPUT_DIR, "GUIA-RESUMEN-10-MAKEFILE.pdf")
...
def main():
    print("=" * 60)
    print("  Module 10 — Makefile Mastery para Flutter + Supabase")
    print("  PDF Builder")
    print("=" * 60)
