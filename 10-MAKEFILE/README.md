# 10 — Makefile Mastery para Flutter + Supabase

> Entiende **cómo** funciona un Makefile y **por qué** cada línea del tuyo hace lo que hace. No más comandos mágicos generados por IA.
...
|---------|-------------|-------|
| [01-que-es-make.md](./01-que-es-make.md) | ¿Qué es Make? ¿Por qué Makefile y no solo scripts? | 🔤 Básico |
...
> **💡 Filosofía**: No necesitas ser experto en Make. Necesitas entender lo suficiente para **leer, modificar y debuggear** el Makefile de tu proyecto sin depender de la IA.

---

## 🔗 Siguiente paso

Después de dominar Makefiles, continúa con:
- [11-GITHUB-ACTIONS/](../11-GITHUB-ACTIONS/) — Cómo se automatiza todo esto en CI/CD
