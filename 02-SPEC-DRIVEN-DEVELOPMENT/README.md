...
> **Nota histórica:** este módulo absorbe y reemplaza al antiguo `02-DISENIO-FEATURE` (metodología FADER). La carpeta original se conserva como referencia histórica; toda la teoría de diseño de features vive ahora aquí, en terminología SDD estándar ([tabla de equivalencias](./05-referencia-rapida.md#equivalencias-de-terminología-glosario-de-dilución)).
...
| 05 | [05-referencia-rapida.md](./05-referencia-rapida.md) | Cheat sheet + glosario de equivalencias FADER/Scrum → SDD |
...
4. Practica sin IA                            → trabajar-sin-ia/
5. Copia un ejemplo real y adáptalo           → ejemplos-cambios/add-cart/
6. Usa la plantilla en tu proyecto            → 04-plantilla-cambio-openspec.md
7. Delega todo y verifica como auditor        → 06-auditoria-codigo-ia.md
```
