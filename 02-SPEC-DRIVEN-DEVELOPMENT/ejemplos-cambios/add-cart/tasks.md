...
- [ ] 1.3 Migración 0007_carts_rls.sql (3 tablas + RPC add_cart_item + RLS)
...
- [ ] 2.3 UseCases: GetCart, AddItemToCart, RemoveItem, UpdateQuantity, ApplyCoupon
...
- [ ] 3.1 CartRepositoryImpl (mapeo excepciones → Failure, delega datasource)
      Éxito: test con mock datasource pasa
      Req: REQ-001..005 · Commit: `feat(cart): implement repository`

- [ ] 3.2 CartState sealed class (Initial/Loading/Loaded/Error)
      Commit: `feat(cart): add cart state`

- [ ] 3.3 CartCubit (transiciones + mensajes EXACTOS de los escenarios)
...
- [ ] 4.1 CartPage + widgets (un render por estado; SnackBar para errores)
