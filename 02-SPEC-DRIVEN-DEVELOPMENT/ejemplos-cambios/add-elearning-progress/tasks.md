...
## 4. Integración
- [ ] 4.1 Migración 0009: tablas + checks (RN010) + vista progreso + RPC enroll + RLS
...
| Req | Tarea(s) | Test |
|-----|----------|------|
| REQ-001 | 1.3, 4.1 | unit+SQL (duplicado, auto-inscripción) |
| REQ-002 | 1.3, 4.1 | SQL gating + cubit locked |
| REQ-003 | 1.1, 4.1 | unit fórmula + SQL trigger |
