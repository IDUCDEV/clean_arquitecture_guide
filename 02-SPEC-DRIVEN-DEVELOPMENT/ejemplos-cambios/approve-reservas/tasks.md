...
- [ ] 2.3 RepositoryImpls (mapeo excepciones → Failure con mensajes exactos)
...
## 4. Integración
- [ ] 4.1 Migración 0008: tablas + RPCs atómicos + RLS + pg_cron
...
| Req | Tarea(s) | Test |
|-----|----------|------|
| REQ-001 | 1.3, 4.1 | unit+SQL (doble reserva, antelación, límites) |
| REQ-002 | 1.3, 2.3 | unit (2h antelación) |
| REQ-003 | 3.1, 3.2 | cubit (transiciones + realtime) |
| REQ-004 | 4.1 | integration RLS |
| REQ-005 | 4.1 (cron) | integration pg_cron |