...
| 06 | [Comunicación y Pseudocódigo](./06-comunicacion-y-pseudocodigo.md) | Cómo escribir pseudocódigo, estructura de comunicación en entrevistas |
| 07 | [Ejercicios de Práctica](./07-ejercicios-practica.md) | 10 ejercicios progresivos (easy→medium→hard) con solución en Dart |
| 08 | [Recursos Externos](./08-recursos-externos.md) | Libros, plataformas, repositorios de práctica |
